            ...
            <div className="container">
                ...
                <div class="card mt-5 shadow mb-1 bg-white" style={{borderRadius:"25px", width:"23rem", marginTop: "-20px"}}>
                    <div class="card-body">
                        ...
                        <div className="card-text">
                            {convertToDollars(totalCosts(stocksData) + totalCosts(cryptosData))}
                        </div>
                    </div>
                </div>
                ...
                <div class="card mt-5 shadow mb-2 bg-white" style={{borderRadius:"25px", width:"23rem", marginTop: "-20px"}}>
                    <div class="card-body">
                        ...
                        <div className="card-text">
                        {((totalGain(stocksData) + totalGain(cryptosData) - totalCosts(stocksData) - totalCosts(cryptosData)) / (totalCosts(stocksData) + totalCosts(cryptosData))*100).toFixed(2)}%
                        </div>
                    </div>
                </div>
                </div>
